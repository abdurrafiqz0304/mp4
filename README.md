...
### Option 4: MAC/LINUX USER
```bash
cd ~/Downloads && curl -L -o mp4.zip https://github.com/abdurrafiqz0304/mp4/archive/refs/heads/main.zip && unzip -o mp4.zip && cd mp4-main && sh install.sh
```